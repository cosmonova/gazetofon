...
export default function RootLayout({
  ...
  return (
    ...
    <head>
      ...
      <meta
          httpEquiv="Content-Security-Policy"
          content="default-src 'self'; img-src 'self' data:; media-src 'self'; connect-src 'self'; font-src 'self' data: https://fonts.gstatic.com; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'  https://fonts.googleapis.com  ; frame-src 'self' https://www.youtube.com https://youtu.be;"
      />
